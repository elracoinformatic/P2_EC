...
output [3:0] ALUCtrl;    //: /sn:0 /dp:1 {0}(995,423)(1106,423){1}
supply0 [3:0] w4;    //: /sn:0 {0}(839,369)(839,405)(966,405){1}
supply0 w3;    //: /sn:0 {0}(610,456)(610,454)(611,454)(611,444){1}
input [1:0] ALUOp;    //: /sn:0 {0}(314,545)(982,545)(982,446){1}
input [5:0] funct;    //: /sn:0 {0}(407,426)(527,426)(527,419)(593,419){1}
wire [3:0] w6;    //: /sn:0 {0}(879,429)(966,429){1}
wire [7:0] w0;    //: /sn:0 {0}(723,451)(879,451)(879,429){1}
wire [3:0] w1;    //: /sn:0 {0}(628,417)(966,417){1}
wire [3:0] w2;    //: /sn:0 {0}(822,482)(956,482)(956,441)(966,441){1}
//: enddecls

  //: output g8 (ALUCtrl) @(1103,423) /sn:0 /w:[ 1 ]
  //: input g4 (ALUOp) @(312,545) /sn:0 /w:[ 0 ]
  mux g3 (.I0(w2), .I1(w6), .I2(w1), .I3(w4), .S(ALUOp), .Z(ALUCtrl));   //: @(982,423) /sn:0 /R:1 /w:[ 1 1 1 1 1 0 ] /ss:0 /do:0
...
wire [5:0] w1;    //: /sn:0 {0}(250,608)(829,608)(829,510)(839,510){1}
wire w17;    //: /sn:0 {0}(395,275)(424,275)(424,274)(434,274){1}
wire w14;    //: /sn:0 {0}(395,197)(413,197)(413,198)(432,198){1}
wire [3:0] w2;    //: /sn:0 {0}(1129,379)(1129,457)(1012,457){1}
wire w15;    //: /sn:0 {0}(395,222)(434,222){1}
//: enddecls
  ...
  //: dip g13 (w1) @(212,608) /sn:0 /R:1 /w:[ 0 ] /st:0
