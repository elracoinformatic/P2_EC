...
//: enddecls
  ...
  //: switch g26 (w1) @(-249,690) /sn:0 /w:[ 5 ] /st:0
  ...
  READ g1 (.RegWrite(w42), .Read_register_1(w10), .Read_register_2(w9), .Write_register(w8), .mux_RegDst(w11), .Sign_ext_in(w6), .clk(w13), .clr(w1), .Write_data(w32), .Read_data_1(w16), .Read_data_2(w15), .Sign_ext_out(w25));   //: @(404, 335) /sz:(255, 283) /sn:0 /p:[ Ti0>1 Li0>0 Li1>0 Li2>0 Li3>1 Li4>0 Bi0>0 Bi1>3 Bi2>1 Ro0<0 Ro1<0 Ro2<5 ]
  ...
  tran g6(.Z(w29), .I(w4[27:0]));   //: @(232,429) /sn:0 /R:1 /w:[ 0 3 4 ] /ss:0
