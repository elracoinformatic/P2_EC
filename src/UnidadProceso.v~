...
wire [31:0] w4;    //: /sn:0 {0}(158,492)(168,492)(168,431)(231,431){1}
//: {2}(232,431)(242,431)(242,446)(172,446)(172,520)(249,520){3}
//: {4}(250,520)(259,520)(259,514)(295,514){5}
//: {6}(296,514)(331,514)(331,507)(343,507){7}
//: {8}(344,507)(354,507)(354,516)(343,516)(343,528)(321,528)(321,546)(303,546)(303,570){9}
//: {10}(303,571)(303,627){11}
...
wire [25:0] w29;    //: /sn:0 {0}(232,426)(232,155)(628,155){1}
...
wire [3:0] w19;    //: /sn:0 {0}(542,184)(542,165)(628,165){1}
...
//: enddecls
  ...
  tran g8(.Z(w9), .I(w4[20:16]));   //: @(296,512) /sn:0 /R:1 /w:[ 1 5 6 ] /ss:0
  ...
  tran g10(.Z(w6), .I(w4[15:0]));   //: @(301,571) /sn:0 /R:2 /w:[ 1 10 9 ] /ss:1
  tran g6(.Z(w29), .I(w4[25:0]));   //: @(232,429) /sn:0 /R:1 /w:[ 0 1 2 ] /ss:0
  tran g7(.Z(w10), .I(w4[25:21]));   //: @(250,518) /sn:0 /R:1 /w:[ 1 3 4 ] /ss:0
  tran g9(.Z(w8), .I(w4[15:11]));   //: @(344,505) /sn:0 /R:1 /w:[ 1 7 8 ] /ss:0
  //: joint g12 (w15) @(787, 497) /w:[ 2 4 1 -1 ]
  tran g5(.Z(w19), .I(w3[31:26]));   //: @(542,187) /sn:0 /R:1 /w:[ 0 1 2 ] /ss:0
