...
//: {2}(445,208)(461,208){3}
//: {4}(443,210)(443,263)(459,263){5}
wire w3;    //: /sn:0 {0}(375,140)(395,140)(395,138)(418,138){1}
wire [31:0] w1;    //: /sn:0 {0}(56,205)(122,205)(122,207)(191,207){1}
wire [31:0] w2;    //: /sn:0 {0}(61,139)(125,139)(125,141)(191,141){1}
wire [3:0] w5;    //: /sn:0 {0}(279,19)(279,47)(276,47)(276,74){1}
//: enddecls

  led g4 (.I(w4));   //: @(466,263) /sn:0 /R:3 /w:[ 5 ] /type:3
  led g3 (.I(w4));   //: @(468,208) /sn:0 /R:3 /w:[ 3 ] /type:2
  led g2 (.I(w3));   //: @(425,138) /sn:0 /R:3 /w:[ 1 ] /type:0
  //: dip g1 (w5) @(279,9) /sn:0 /w:[ 0 ] /st:0
  //: dip g6 (w2) @(23,139) /sn:0 /R:1 /w:[ 0 ] /st:0
  //: dip g7 (w1) @(18,205) /sn:0 /R:1 /w:[ 0 ] /st:0
  //: joint g5 (w4) @(443, 208) /w:[ 2 -1 1 4 ]
  EXE g0 (.ALU_operation(w5), .A(w2), .B(w1), .ALU_result(w4), .Zero_signal(w3));   //: @(192, 75) /sz:(182, 314) /sn:0 /p:[ Ti0>1 Li0>1 Li1>1 Ro0<0 Ro1<0 ]
